...
# Skip first 8 values = # pointer -> we dont care about that
# Get 9
...
if v_a == 0:
    v_a = l_i_pointers
    p1_length_on = True
    current_section_length = section_value_2 - section_value_1
else:
    v_b = l_i_pointers
    section_value_1 = int(v_a, 16)
    section_value_2 = int(v_b, 16)
    ...
    current_section_length = " (" + current_section_length + ") -> "
if p1_length_on:
v_a = v_b  # Transfer Section 2 values to Section 1 for next use
if
    ...
    if make_p_a:
        ...
        if i <= 8:   # 8 is 4x bytes = length of pointer
            ...
            if i == 8:
                ...
                # print(pointer_values + " " + l_i_pointers + "  Pointer #" + k_amount)
                ...
                if y < x:
                    ...
                    byte_07 = v_a[4:6]
                    byte_08 = v_a[6:8]
                    l_i_values_a = str(byte_08 + byte_07 + byte_06 + byte_05)
    
                    byte_09 = v_b[0:2]
                    byte_0A = v_b[2:4]
                    byte_0B = v_b[4:6]
                    byte_0C = v_b[6:8]
                    l_i_values_b = str(byte_0C + byte_0B + byte_0A + byte_09)
                    """
                    #l_i_values_a = no_line_jump_header[a:b]
                    #l_i_values_b = no_line_jump_header[a:b]
...
# Convert pointer_amount to little-indian
